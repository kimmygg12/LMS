...
class ReportController extends Controller
{
    ...
    //         ? Book::all()->map(function ($book) use ($startDate, $endDate) {
    //             $totalBorrowed = LoanBook::where('book_id', $book->id)
    ...
    //             $loanHistoryCount = LoanBookHistory::where('book_id', $book->id)
    //                 ->count();

    //             $remainingQuantity = $book->quantity + $quantityOnLoan;
    //             $remainingQuantitycount = $quantityOnLoan + $loanHistoryCount;
    ...
    //                 'remaining_quantity' => $remainingQuantity,
    //                 'quantity_on_loan' => $quantityOnLoan,
    //                 'loanHistoryCount' => $loanHistoryCount,
