<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
    <div class="sb-sidenav-menu">
        <div class="nav">
            ...
            <a class="nav-link {{ request()->routeIs('books.index', 'books.create', 'subjects.index', 'subjects.create', 'books.show', 'books.edit','subjects.edit') ? 'active' : '' }}"
                data-toggle="collapse" href="#collapseBook" role="button"
                aria-expanded="{{ request()->routeIs('books.index', 'books.create', 'subjects.index', 'subjects.create', 'books.show', 'books.edit','subjects.edit') ? 'true' : 'false' }}"
            ...
            <div class="collapse {{ request()->routeIs('books.index', 'books.create', 'subjects.index', 'subjects.create', 'books.show', 'books.edit','subjects.edit') ? 'show' : '' }}"
                id="collapseBook">
