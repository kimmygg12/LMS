                        ...
                        <tbody>
                            @forelse ($overdueDetails as $detail)
                                <tr>
                                    ...
                                    {{-- <td class="text-center">{{ $detail['member']->study->name ?? 'N/A' }}</td>
                                    <td class="text-center">{{ $detail['book']->subject->name ?? 'N/A' }}</td> --}}
                                    ...
                                    {{-- <td class="text-center">{{ number_format($detail['fine']) }}៛</td> --}}
                                    <td class="text-center">
